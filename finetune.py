...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/content/drive/MyDrive/model-soups/model/finetune_cp_19.pt'))
    ...
    for epoch in range(args.epochs):
        ...
        a = confusion_matrix(pred_array, gt_array)
        print(a)
